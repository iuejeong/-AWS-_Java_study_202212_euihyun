...
CREATE TABLE `course_mst` (
  `course_mst` int NOT NULL,
  `student_id` int NOT NULL,
  `lecture_id` int NOT NULL,
  `instructor_id` int NOT NULL,
  PRIMARY KEY (`course_mst`)
...
INSERT INTO `course_mst` VALUES (1,1,1,1),(2,2,1,1),(3,3,1,1),(4,1,3,3);
...
LOCK TABLES `lecture_mst` WRITE;
/*!40000 ALTER TABLE `lecture_mst` DISABLE KEYS */;
INSERT INTO `lecture_mst` VALUES (1,'java',100000),(2,'java',90000);
/*!40000 ALTER TABLE `lecture_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-19 17:48:04
