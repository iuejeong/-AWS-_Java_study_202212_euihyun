package usermanagemaent.repository;
...
import usermanagemaent.config.DBConnectionMgr;
import usermanagemaent.entity.RoleDtl;
import usermanagemaent.entity.RoleMst;
import usermanagemaent.entity.User;

/*
 * UserDao 객체라고 부른다 = 데이터에 접근하는 용도
 * */
...
public class UserRepository {
	...
	public int saveUser(User user) {
		...
		try {
			...
			pool.freeConnection(con, pstmt, rs); // 메모리 반환
		}
